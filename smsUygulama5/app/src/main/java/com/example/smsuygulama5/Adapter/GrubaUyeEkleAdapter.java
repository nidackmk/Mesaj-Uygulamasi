...
public class GrubaUyeEkleAdapter extends RecyclerView.Adapter<GrubaUyeEkleAdapter.ViewHolder>{
    ...
    public GrubaUyeEkleAdapter(ArrayList<GrupSecModals> grup_sec_item, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new GrubaUyeEkleAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.grup_sec_item, parent, false));
